...
<div class="row g-2">
    ...
    <div class="col-sm input-group">
        ...
        <input type="text" class="form-control" value="{{$item->versao}}" aria-label="Zip" readonly>
    </div>
    <div class="col-sm input-group">
        <span class="input-group-text">Dicas</span>
        <input type="text" class="form-control" value="{{$item->dica}}" aria-label="Zip" readonly>
    </div>
</div>
<?php
}
